...
def main():
    ...
    for i in range(-12, 60): # draw the right border
        ox.append(60.0)
        oy.append(i)
    for i in range(-12, 61): # draw the top border
        ox.append(i)
        oy.append(60.0)
    for i in range(-12, 61): # draw the left border
        ox.append(-12.0)
        oy.append(i)
...
CT1 = 15
CC1 = 1800
C1 = (CF1 * F1 * T + CT1 * T + CC1) * 12
print("cost of A321neo in scenario 1 =", C1)

F2 = 84
CT2 = 21
CC2 = 2000
C2 = (CF1 * F2 * T + CT2 * T + CC2) * 10
print("cost of A330-900neo in scenario 1 = ", C2)

F3 = 90
CT3 = 27
CC3 = 2500
C3 = (CF1 * F3 * T + CT3 * T + CC3) * 9
print("cost of A350-900 in scenario 1 = ", C3)

CF2 = 0.88
CT1_2 = 20
C1_2 = (CF2 * F1 * T + CT1_2 * T + CC1) * 5
print("cost of A321neo in scenario 2 = ", C1_2)

CT2_2 = 27
C2_2 = (CF2 * F2 * T + CT2_2 * T + CC2) * 5
print("cost of A330-900neo in scenario 2 = ", C2_2)

CT3_2 = 34
C3_2 = (CF2 * F3 * T + CT3_2 * T + CC3) * 4
print("cost of A350-900 in scenario 2 = ", C3_2)

CF3 = 0.95
CT1_3 = 10
C1_3 = (CF3 * F1 * T + CT1_3 * T + CC1) * 13
print("cost of A321neo in scenario 3 = ", C1_3)

CT2_3 = 15
C2_3 = (CF3 * F2 * T + CT2_3 * T + CC2) * 9
print("cost of A330-900neo in scenario 3 = ", C2_3)

CT3_3 = 20
C3_3 = (CF3 * F3 * T + CT3_3 * T + CC3) * 8
print("cost of A350-900 in scenario 3 = ", C3_3)
